...
Table helpers used in Setelis. Currently only fixed table header...

- Demo: http://setelis.github.io/angular-se-tables/demo
* **TODO - more info**

# Install:

 - Add library to your project: ```bower install angular-se-tables --save```
 - Add module to your project: ```angular.module("DemoApp", ["seTables"])...```
 - Add ```data-se-tables-header-fixed``` to ```thead```
